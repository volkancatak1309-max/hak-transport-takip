-- ═══════════════════════════════════════════════════════════════════════════
--  GALZURA-DEMO — ŞEMA HİZALAMA 043 → 107
...
--
--  ⚠️ BOŞ VERİTABANINDA KULLANMAYIN — onun dosyası galzura-demo-full.sql.
--
--  BU KİRACIDA NE DEĞİŞECEK — TABLO LİSTESİ ÖLÇÜLDÜ (24.08.2026, canlı)
--
...
--    --    Bu kiracıda ölçülen taban 35 → 35 + 13 = 48.
...
begin
  ...
  if v_eksik is not null then
    raise exception
      'DURDURULDU: temel tablolar yok (%). Bu dosya MEVCUT bir kurulumu 078''e çeker; SIFIRDAN kurulum için db/install/galzura-demo-full.sql kullanın.',
      v_eksik;
  end if;
...
-- 102 — 101'İN v2'SİNDEKİ O(n²) PENCERE ÇERÇEVESİ DÜZELTMESİ  —  ÇALIŞTIRILDI 17.09.2026
--
-- ✅ ÜÇ KİRACIDA DA UYGULANDI (17.09.2026): HAK61 · Sendigo · galzura-demo.
--    Doğrulama: tablo 2 · yeni fonksiyon 4 · ESKİ fonksiyonlar 2 ·
--    eski_cerceve false (102'nin O(n²) çerçevesi yok).
