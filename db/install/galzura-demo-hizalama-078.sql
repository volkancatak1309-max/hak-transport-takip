-- ═══════════════════════════════════════════════════════════════════════════
--  GALZURA-DEMO — ŞEMA HİZALAMA 043 → 078
...
--
--  ⚠️ BU KİRACIDA ÖLÇÜM YAPILAMADI — service_role anahtarı Claude''da YOK
...
--    -- 48 bekleniyor (47 + purge fonksiyonu tablosu yok, 054 yalnız fonksiyon)
