...
export const TABAN = {
   ...
   *
   * ⚠️ ÖZNESİ YOK (worker ve vehicle ikisi de null) — kiracının kendi
 ...
 *
 * Sıra: şoför → araç → (yok: filo geneli). Bu sıra `haftalik_aksiyonlar`
...
export function ozneKimligi(a: {
  ...
  return a.workerId ?? a.vehicleId ?? null;
}
